    ...
    fieldsets = (
        ...
        (_('Limits'), {
            'fields': (
                ...
                'max_storage_gb', 'max_api_calls_per_hour'
            )
        }),
        ...
        (_('Compliance'), {
            'fields': ('gdpr_enabled', 'data_retention_days', 'audit_log_retention_days'),
            'classes': ('collapse',)
        }),
        (_('Branding'), {
...
class FeatureAdmin(admin.ModelAdmin):
    ...
    filter_horizontal = ('tenant_whitelist',)
    ordering = ('name',)
    ...
    def whitelisted_tenants_count(self, obj):
        ...
        count = obj.tenant_whitelist.count()
        if count > 0:
