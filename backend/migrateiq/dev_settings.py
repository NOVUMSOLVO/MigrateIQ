"""
Simplified development settings for MigrateIQ.
"""
...
INSTALLED_APPS = [
    ...
    # Third-party apps (minimal for development)
    'rest_framework',
    'corsheaders',
    'django_filters',
    'drf_spectacular',
    # Local apps (enhanced with all modules)
    'core',
    'authentication',
...
ROOT_URLCONF = 'migrateiq.dev_urls'
